...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 308,
	BlipColor = 5,
	BlipName = Config.nameJobLabel.." : Trabalho de Salvamento do Oceano",
	hint = 'Pressiona ~INPUT_CONTEXT~ para acessares o trabalho.',
  },
  ...
  VehicleSpawner = {
	...
	Color = {r = 11, g = 203, b = 159},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Veiculo",
	hint = 'Pressiona ~INPUT_CONTEXT~ para pegares um veiculo.',
  },
  ...
  VehicleDeleter = {
	...
	Color = {r = 255, g = 0, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Devolver Veiculo",
	hint = 'Pressiona ~INPUT_CONTEXT~ para devolveres o veiculo.',
  },
  ...
  Vente = {
	...
	ItemDrop = 100,
	ItemPrice  = 800,
	hint = 'Pressiona ~INPUT_CONTEXT~ para transformares as tuas peças coletadas.',
  },
